...
class client {
    constructor(config, server) {
        ...
        this.getUser = userId => {
            const url = `${this.endpoint}/${userId}?fields=name,first_name,profile_pic,gender&access_token=${this.accessToken}`;
        ...
        Object.entries(Object.assign({}, config, this.setClientConfig())).forEach(([key, value]) => {
            this[key] = value;
        });
